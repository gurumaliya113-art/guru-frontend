...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    setBusy(true);
    try {
      // Simulated Google data (in real app, this comes from Google SDK)
      const googleData = {
      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-3xl shadow-lg border border-gray-200">
        ...
        <div className="space-y-4">
          <button
            ...
            disabled={busy}
            className="w-full flex items-center justify-center gap-3 rounded-2xl bg-white border border-gray-300 px-4 py-3 text-gray-700 font-semibold hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-70"
          >
